...
namespace ParametricDramDirectoryMSI
{
   class TLB
   {
      private:
         ...
         /* Those parameters are not constants anymore */
         UInt32 SIM_PAGE_SHIFT;
         IntPtr SIM_PAGE_SIZE;
         IntPtr SIM_PAGE_MASK;
      ...
      public:
         TLB(String name, String cfgname, core_id_t core_id, UInt32 page_size_bits, UInt32 num_entries, UInt32 associativity, TLB *next_level);

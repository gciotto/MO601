...
/* commom/core/memory_subsystem/parametric_dram_directory_msi/ */

namespace ParametricDramDirectoryMSI
{

TLB::TLB(String name, String cfgname, core_id_t core_id, UInt32 page_size_bits, UInt32 num_entries, UInt32 associativity, TLB *next_level)
   : m_size(num_entries)
   , SIM_PAGE_SHIFT (page_size_bits)
   , SIM_PAGE_SIZE (1L << SIM_PAGE_SHIFT)
   , SIM_PAGE_MASK (~(SIM_PAGE_SIZE - 1))
